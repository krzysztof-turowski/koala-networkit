...
auto test_set_exact = testing::Values(
    ...
    VertexColoringParameters{10,
         {{0, 2}, {0, 3}, {0, 4}, {0, 5}, {1, 2}, {1, 3}, {1, 4}, {1, 5}, {2, 6}, {2, 8},
          {3, 4},
          {3, 6}, {4, 6}, {5, 6}, {5, 7}, {5, 9}, {7, 8}, {7, 9}, {8, 9}},
         3},
    VertexColoringParameters{8,
         {{0, 1}, {0, 2}, {0, 4}, {0, 6}, {1, 2}, {1, 3}, {1, 7}, {2, 3}, {2, 4}, {3, 5},
          {3, 7},
          {4, 5}, {4, 6}, {5, 6}, {5, 7}, {6, 7}},
         4},
    VertexColoringParameters{8,
         {{0, 1}, {0, 2}, {0, 4}, {0, 6}, {1, 3}, {1, 5}, {1, 7}, {2, 3}, {2, 4}, {2, 5},
          {2, 6},
          {3, 4}, {3, 5}, {3, 7}, {4, 6}, {4, 7}, {5, 6}, {5, 7}, {6, 7}},
         4},
    VertexColoringParameters{10,
         {{0, 1}, {0, 2}, {0, 3}, {0, 5}, {0, 6}, {0, 7}, {1, 2}, {1, 3}, {1, 4}, {1, 6},
          {1, 7},
    ...
    VertexColoringParameters{9,
         {{0, 4}, {0, 5}, {0, 6}, {0, 8}, {1, 5}, {1, 6}, {1, 7}, {1, 8}, {2, 6}, {3, 7},
          {3, 8},
