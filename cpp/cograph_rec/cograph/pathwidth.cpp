...
long long Koala::CographRecognition::SubtreeSize(long long n, long long v) {
    if (type[v] == 2) {
        size[v] = 1;
        return 1;
    } else {
...
long long Koala::CographRecognition::pathwidth(long long n, long long v) {
    if (type[v] == 2) {
        return 1;
    } else {
        long long l = 0, r = 0;
...
long long Koala::CographRecognition::GetCographPathwidth() {
