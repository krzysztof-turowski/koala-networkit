...
namespace Koala {
    ...
    bool LeftRightPlanarity::isPlanar(const Graph& G) {
     ...
     bool LeftRightPlanarity::lrAlgorithm(const Graph& G, node root, std::vector<int>& dfsHeight) {
        ...
        void LeftRightPlanarity::mergeFringes(std::vector<std::vector<LeftRightPlanarity::Fringe>>& fringes, int dfs_height) {
        ...
        LeftRightPlanarity::Fringe LeftRightPlanarity::getMergedFringe(std::vector<LeftRightPlanarity::Fringe>& upperFringes) {
