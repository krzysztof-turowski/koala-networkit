# koala-networkit
KOALA library fork built on NetworKit graph library
...
1. [Reading and writing graphs](https://github.com/krzysztof-turowski/koala-snap/blob/main/io/graph_io.hpp): [graph6](https://users.cecs.anu.edu.au/~bdm/data/formats.html), [sparse6](https://users.cecs.anu.edu.au/~bdm/data/formats.html), [DIMACS](http://prolland.free.fr/works/research/dsat/dimacs.html), [DIMACS binary](https://mat.tepper.cmu.edu/COLOR/format/README.binformat) formats
