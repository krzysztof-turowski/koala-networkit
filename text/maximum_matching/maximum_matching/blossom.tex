...
\While{an augmenting path has not been found}
    \While{a useful edge $\{u, v\}$ exists}
        \State{$\textsc{consider\_edge}(\{u, v\})$}
    \EndWhile
...
\[\delta_2=\min_{\substack{\{u, v\}\in E \\ \text{$u$ even, $v$ free}}} slack(\{u, v\}) = \min_{\substack{u \text{ even}}} slack(edge(u))\] 
