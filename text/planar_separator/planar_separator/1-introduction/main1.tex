...
This thesis deals with algorithms based on planar separators. Let's define
what a separator is at first then.
...
has a separator of size 1 (a single vertex), which removal partitions T into
...
\begin{theorem}\label{thm:fnseparator}
    ...
    such that no edge connects any vertex in $A$ and $B$, neither $A$ or $B$
...
$ $\beta = 1$ is called planar separator theorem. First breaktrough in that area
