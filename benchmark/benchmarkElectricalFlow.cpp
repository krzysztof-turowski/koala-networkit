...
struct FlowBenchmark {
  FlowBenchmark(string name, int maximumFlow, steady_clock::time_point begin,
                steady_clock::time_point end)
      : name(name), maximumFlow(maximumFlow),
...
FlowBenchmark runFractionalElectricalFlow(const NetworKit::Graph &G, int s,
                                          int t) {
  auto begin = steady_clock::now();
...
void benchmarkAverage(
    function<FlowBenchmark(Graph &, node s, node t)> runAlgorithm,
